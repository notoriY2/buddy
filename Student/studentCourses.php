...
// Get the studentNo from session
...
FROM 
    student
INNER JOIN 
    level ON student.level_id = level.level_id
INNER JOIN 
    faculty ON student.faculty_id = faculty.faculty_id
INNER JOIN 
    department ON student.department_id = department.department_id
INNER JOIN 
    course_assignment ON course_assignment.faculty_id = faculty.faculty_id 
    AND course_assignment.department_id = department.department_id
INNER JOIN 
    course ON course_assignment.course_id = course.course_id 
...
$stmt = $conn->prepare("
    SELECT student.student_id, student.firstName, student.lastName, student.email, profile.image 
    FROM student 
    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a href="studentCourses.php" class="active">
                            ...
                            <tbody>
                                ...
                                if ($courseResult->num_rows > 0) {
                                    ...
                                    while($row = $courseResult->fetch_assoc()) {
                                        ...
                                        echo "<td><span class='badge badge-success'>" . htmlspecialchars($row['semesterName']) . "</span></td>";
                                        echo "</tr>";
                                        $counter++;
                                    }
                                } else {
                                    echo "<tr><td colspan='8'>No courses found for this student.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
