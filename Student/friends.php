...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['user_id']) && isset($_POST['action'])) {
    ...
    if ($action === 'accept') {
        ...
        $addFriendStmt = $conn->prepare("INSERT INTO friends (student_id1, student_id2, status, created_at) VALUES (?, ?, 'accepted', NOW())");
        $addFriendStmt->bind_param("ii", $studentId, $userId);
...
<div class="container">
    ...
    <div class="profile-intro">
        ...
        <form class="create-group-form" action="" method="get">
                    ...
                    <button type="submit" name="view" value="friends">View All Friends</button>
                </form>
    </div>
</div>
