...
<input type="hidden" id="croppedImageData" name="croppedImageData">
                        ...
                        <a href="#" class="add-text-btn">
                            <input type="text" id="text-input" name="story_text" placeholder="Start Typing" style="height: 100px; font-size: 20px; padding: 10px; width: 100%;">
                        </a>
