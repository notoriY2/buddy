...
while ($story = $result->fetch_assoc()) {
    $storyId = htmlspecialchars($story['story_id']); // Add this line to get story ID
...
<?php } ?>
            ...
            <!-- Add other static stories as needed -->

            <!-- Additional Static Stories as needed -->
        </div>
    </div>
</div>
<script>
