        ...
        <div class="dash-content">
            <div class="animated fadeIn">
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    student.level_id,student.session_id,student.faculty_id,student.department_id
                    from student
                    ...
                    where student.level_id ='$levelId' and student.session_id ='$sessionId' 
                    and student.department_id ='$departmentId' and student.faculty_id ='$facultyId'");
                    $cnt=1;
                    ...
                    <td><a href="viewSemesterResult.php?semester_id=1&studentNo=<?php echo $row['studentNo'];?>&level_id=<?php echo $row['level_id'];?>&session_id=<?php echo $row['session_id'];?>" title="View Details"><i class="fa fa-eye fa-1x"></i> View</a></td>
                    <td><a href="viewSemesterResult.php?semester_id=2&studentNo=<?php echo $row['studentNo'];?>&level_id=<?php echo $row['level_id'];?>&session_id=<?php echo $row['session_id'];?>" title="View Details"><i class="fa fa-eye fa-1x"></i> View</a></td>
                    <td><a href="viewFinalResult.php?studentNo=<?php echo $row['studentNo'];?>" title="View Details"><i class="fa fa-eye fa-1x"></i> View</a></td>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
                    }
