    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li>
                    <a href="#" class="toggle-submenu" data-submenu="course-submenu">
                        <i class="fas fa-book-open"></i>
                        <span class="link-name">Courses</span>
                        <i class="fas fa-chevron-right toggle-icon"></i>
                    </a>
                    <ul class="course-submenu submenu" style="display: none;">
                        <li><a href="createCourses.php">Create Course</a></li>
                    </ul>
                </li>
                <li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-hover table-striped table-bordered">
                                    ...
                                    <?php
        $stmt = $conn->prepare("
            SELECT staff.dateCreated, staff.staff_id, staff.name
            FROM staff 
            WHERE isAssigned = '0' AND staffType_id = '2'
            ORDER BY staff.dateCreated ASC
        ");
        $stmt->execute();
        $result = $stmt->get_result();
        $cnt = 1;
