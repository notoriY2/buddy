...
if(isset($_POST['submit'])){
    ...
    // Use prepared statements to prevent SQL injection
    $stmt = $conn->prepare("UPDATE faculty SET facultyName = ?, dateCreated = ? WHERE faculty_id = ?");
    $stmt->bind_param("ssi", $facultyName, $dateCreated, $_SESSION['edit_id']);
    $query = $stmt->execute();

    if ($query) {
        $alertStyle = "alert alert-success";
        $statusMsg = "Faculty updated successfully!";
    } else {
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="facultyName" class="control-label mb-1">Faculty Name</label>
                                                        <input id="facultyName" name="facultyName" type="text" class="form-control" value="<?php echo htmlspecialchars($rowi['facultyName']); ?>" placeholder="Faculty Name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
