...
if (isset($_POST['submit'])) {
    ...
    // Ensure $staff_id is set and valid
    if (isset($staff_id)) {
        ...
        if ($row && password_verify($currentPassword, $row['password'])) {
            ...
            $updateQuery = mysqli_query($conn, "UPDATE staff SET password='$hashedNewPassword', isPasswordChanged=1 WHERE staff_id='$staff_id'");
        ...
        $alertStyle = "alert alert-danger";
        $statusMsg = "User is not logged in.";
    }
}
            ...
            <div class="card-body">
                <form action="upload_image.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="file" name="profileImage" id="profileImage" accept=".jpeg,.jpg,.png" class="form-control-file">
                    </div>
