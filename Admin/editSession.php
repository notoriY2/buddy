...
if(isset($_POST['submit'])){
    ...
    // Use prepared statements to prevent SQL injection
    $stmt = $conn->prepare("UPDATE session SET sessionName = ? WHERE session_id = ?");
    $stmt->bind_param("si", $sessionName, $_SESSION['edit_id']);
    $query = $stmt->execute();
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="sessionName" name="sessionName" type="text" class="form-control cc-exp" value="<?php echo $rowi['sessionName'];?>" placeholder="Session Name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
